...
export default function OnlineSessionssecond() {
	const Async = {
		textDecoration: "none",
		fontWeight: "bold",
		fontSize: "xx-large",
		...
		<>
			...
			<div className="container" style={container}>
				<div className="content">
					...
					<h5 style={first}>(Second)</h5>
					<br />
					<br />
					<p style={stars}>
						**This is a paid online session. You along with 4 other people will
					...
					<li style={list}>Fees: 599/- INR or 7.10 USD</li>
					...
					<li style={list}>No. of people : 5</li>
					<br />
					{/* <br /> */}
					<Link to="/confirm">
